...
class ServiceController extends Controller
{
    ...
    public function get_service_orders( Request $request)
    {
        ...
        $orders = Order::join('services', "services.id", "=", "order.service_id")->Select("services.service", "services.id AS service_id", "order.total_hours", "order.start_at", "order.price As total_price", "services.cost_per_hour ", "order.location", "order.user_id", "order.status")->With(['User' => function ($query) {
            $query->select('id', 'full_name', "picture");
