        ...
        @php
            ...
            foreach ($users as $item ) {
              $table_data[] = (object)[
                ...
                (object)["type"=> "anchor", "value" => "Orders", "name" => "Transactions", "href" => route("admin_get_transactions", $item), "color"=>"success"],
                ...
                (object)["type"=> "string", "value" => $item->total_discounts, "name" => "Orders Balance"],
