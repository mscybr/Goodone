      ...
      <div class="col-6 mx-auto">
        ...
        @php
            ...
            foreach ($services as $item ) {
              $table_data[] = (object)[
                (object)["type"=> "anchor", "value" => $item->user->full_name, "name" => "Service", "href" => route("admin_get_user", $item->user_id), "color"=>"success"],
                ...
                (object)["type"=> "string", "value" => $item->country." / ".$item->city, "name" => "City"],
